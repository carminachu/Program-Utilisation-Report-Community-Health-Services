...
- **Data Quality Check**: Data quality checks were conducted, identified issues were documented, and the data was cleaned prior to analysis. Details can be found here. [[link](https://docs.google.com/spreadsheets/d/1Vgt3GzcMAUATE4Zv8Re8BvviDPzgHTm_Fkb_OmU2-60/edit?gid=14044983#gid=14044983)].
- **Power BI Report**: An interactive Power BI report for exploring program utilisation is available in this repository.
...
Prior to beginning the analysis, a variety of checks were conducted for quality control and familiarization with the datasets can be found [here](https://docs.google.com/spreadsheets/d/1Vgt3GzcMAUATE4Zv8Re8BvviDPzgHTm_Fkb_OmU2-60/edit?usp=sharing). It also includes data dictionary.
...
<img width="290" height="251" alt="image" src="https://github.com/user-attachments/assets/dadf30fc-72a4-4d2d-853c-bc4fc1797aeb" />

<img width="891" height="330" alt="image" src="https://github.com/user-attachments/assets/ec80ad91-8886-48ae-b5bf-62b7cad4bc04" />

### **🛠️Service Delivery Trend** ###
...
<img width="825" height="349" alt="image" src="https://github.com/user-attachments/assets/4df1ab65-0024-491b-aa30-805061e51cdf" />
...
- **Average wait days remained stable at ~12 days** across all services from 2023 to 2024, indicating consistent access and operational efficiency.
...
- Analysis of service utilisation by Equity Indicators and Risk Factors in 2024 shows the following contributions from each group:
...
<img width="578" height="461" alt="image" src="https://github.com/user-attachments/assets/ba988aa9-7f4b-4e5e-b787-9f4cb9c5ad28" />
